    ...
    def _scan_with_laser(self, x, y, angle, target_x, target_y, walls):
        ...
        for wall in walls:
            ...
            if self._line_intersects_rect(x, y, laser_end_x, laser_end_y, wall_rect):
                ...
                laser_end_x, laser_end_y = self._get_intersection_point(x, y, laser_end_x, laser_end_y, wall_rect)
                break

        # Check if the laser hits the enemy
        enemy_rect = pygame.Rect(target_x - 10, target_y - 10, 20, 20)  # Size of the enemy
