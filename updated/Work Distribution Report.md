...
The first week we both worked on this. We decided to use Meret's version of the engine with the basic physics, a maze and enemies and bullets.
At that point it was only possible to play the game alone.
